...
public class OverlayUIDemo : MonoBehaviour {
	...
	void OverlaySwitch()
	{
		...
		if ( Input.anyKeyDown || OVRInput.GetDown(OVRInput.Button.Any) || Input.GetMouseButtonDown(0) || Input.GetMouseButtonDown(1))
		{
#if UNITY_ANDROID
...
//			float cylinderArcAngle = currentOverlay.transform.localScale.x / cylinderRadius;
//			float cylinderHeight = currentOverlay.transform.localScale.y;
